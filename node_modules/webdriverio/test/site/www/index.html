...
<body>
    ...
    <section class="page">
        ...
        <div class="viewportTest outTopLeft"></div>
        <div class="viewportTest outTopRight"></div>
        <div class="viewportTest outBottomLeft"></div>
        <div class="viewportTest outBottomRight"></div>
        ...
        <script>
            ...
            function addRow(container, test, count) {
            ...
            function staleElementTest1() {
                ...
                function loop() {
                    count++;
                    removeRow(lastRow);
                    lastRow = addRow(container, 1, count);
                }
